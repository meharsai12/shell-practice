...
SCRIPT_NAME=$(echo $0 | cut -d "." -f1)     # $0 ->-> it will give the script name of the script running
LOG_FILE="$LOGS_FOLDER/$SCRIPT_NAME.log"

mkdir -p $LOGS_FOLDER   # -p is we need to add because it wil create agin if we run script 
